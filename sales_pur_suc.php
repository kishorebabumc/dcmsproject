                        ...
                        <div class="card">														
							...
							<div class="content table-responsive table-full-width">
                                <table class="table ">
                                    ...
                                    <tbody>
										<tr> <form action="sales_pur_suc_com.php" method ="post">
											<td><?php echo $row['CreditorDebtor']; ?></td>
											<td><?php echo $totvalue; ?></td>
											<input type="hidden" value = "<?php echo $subid; ?>" name = "subid">
											<input type="hidden" value = "<?php echo $totvalue; ?>" name = "totalvalue">
											<td><button type="submit" class='btn btn-info btn-fill'>Proceed</button></td>
											<form>
										</tr>
